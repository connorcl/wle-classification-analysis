...
It can be seen that the random forest model achieves a classification accuracy of over 99%, and thus seems to be effective at distinguishing between the different weightlifting techniques using accelerometer data. Additionally, since this accuracy figure was obtained through 10-fold cross-validation, it should be a close estimate of the out-of-sample accuracy. Therefore, no further models are trained.